...
function refreshSwatch() {
  console.log("refreshSwatch called");
...
$(function() {
    ...
    image.onload = function() {
      ...
      var oridata = ori_ctx.getImageData(0, 0, sz, sz); // grab the data pointer. Our dataset.
      console.log(ori_ctx);
      // start the regression!
      setInterval(tick, 1);
    }
    image.src ="http://theendearingdesigner.com/wp-content/uploads/2016/08/img_57b906358f702.jpg" ;
